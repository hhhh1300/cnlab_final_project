...
export default function CreateActivitySheet({ isOfficial }: CreateActivitySheetProps) {
        ...
        <Card className="w-screen max-w-xl mx-auto mt-10 shadow-lg rounded-lg overflow-hidden flex flex-col">
          <CardHeader className="bg-gray-50 p-6">
            ...
            <CardDescription className="text-gray-700 mt-2">
              {isOfficial ? (
                <span className="text-gray-600 items-center">此為官方活動</span>
              ) : (
                <span className="text-gray-600 items-center">此為一般活動</span>
              )}
            </CardDescription>
          </CardHeader>
              ...
              <div>
                ...
                <span className="text-gray-900">
                  <FormField
                    ...
                    render={({ field }) => <DateTimePicker granularity="second" ref={ref} />}
                  />
                </span>
                <div></div>
